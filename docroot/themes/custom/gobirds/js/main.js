       ...
       // var player = new Vimeo.Player(videoElement, options);
        ...
        if (vimeoPlayerCtrl =="1" || vimeoPlayerCtrl =="3") {
            ...
            if (vimeoPlayerCtrl =="3") {
                muteUnmuteIcon.src = '/themes/custom/gobirds/unmute.svg';  // Change to mute icon
            }

            // If the video plays to completion, reset the play button
            videoElement.addEventListener('ended', function(e) {
                playPauseIcon.src = '/themes/custom/gobirds/play-2.svg';  // Change to play icon
            })
            ...
            playPauseBtn.addEventListener('click', function () {
                if (videoElement.paused) {
                    ...
                    if (os == "1") {
                        ...
                        playPauseIcon.src = '/themes/custom/gobirds/pause.svg';  // Change to pause icon
                    }
        ...
        if (vimeoPlayerCtrl =="2" || vimeoPlayerCtrl =="3") {
            ...
            muteUnmuteBtn.addEventListener('click', function () {
                if (videoElement.muted) {
                    ...
                    muteUnmuteIcon.src = '/themes/custom/gobirds/unmute.svg';  // Change to unmute icon
                } else {
                    videoElement.muted = true;
                    muteUnmuteIcon.src = '/themes/custom/gobirds/mute.svg';  // Change to mute icon
                }
            });
        }
