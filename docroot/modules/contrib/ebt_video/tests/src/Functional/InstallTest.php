...
namespace Drupal\Tests\ebt_video\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_video'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_video']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_video');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_video'));
