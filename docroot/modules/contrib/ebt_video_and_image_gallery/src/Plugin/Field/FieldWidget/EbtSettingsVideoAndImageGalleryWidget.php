...
namespace Drupal\ebt_video_and_image_gallery\Plugin\Field\FieldWidget;
 ...
 *   label = @Translation("EBT Video and Image Gallery settings"),
 *   field_types = {
 *     "ebt_settings"
 *   }
 * )
 */
class EbtSettingsVideoAndImageGalleryWidget extends EbtSettingsDefaultWidget {
