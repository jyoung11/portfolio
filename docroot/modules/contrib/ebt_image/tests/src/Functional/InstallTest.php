...
namespace Drupal\Tests\ebt_image\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_image'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_image']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_image');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_image'));
