...
namespace Drupal\Tests\ebt_hero\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_hero'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_hero']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_hero');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_hero'));
