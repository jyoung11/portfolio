# Addventures customized Acquia Cloud Hooks

## Installation 

This repo tracks hooks for both Drupal 7 and Drupal 8 environments. NOTE: Work on a release for Drupal 7 environments is in progress. 

1. navigate tot he releases page: https://github.com/addventures/acquia_hooks_common/releases
2. Download the relevant Drupal version release and unzip/untar in the root directory or your local project codebase. 
3. Commit the hooks to the repo and test by pushing code to Acquia Cloud DEV inspect the script output of the commit push.

TODO: add more details on the customizations and instructions for usage
